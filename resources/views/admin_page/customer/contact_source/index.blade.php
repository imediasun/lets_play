...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            <h3 class="text-themecolor m-b-0 m-t-0">Источники контактов</h3>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('super_admin') }}">Главная</a></li>
                <li class="breadcrumb-item active">Источники контактов</li>
            </ol>
        </div>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-block">
                    <h4 class="card-title">Источники контактов</h4>
                    <h6 class="card-subtitle">Список источников контактов</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-primary btn-icon fa fa-edit"
                                           href="{{ route('admin.customer.contact-sources.edit', ['id' => $source->id]) }}"
                                           data-toggle="tooltip"
