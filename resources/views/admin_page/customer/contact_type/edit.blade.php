    ...
    <div class="row page-titles">
        <div class="col-md-6 col-8 align-self-center">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.customer.contact-types.index') }}">Список типов контактов</a></li>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-block">
                    ...
                    <h6 class="card-subtitle">Редактировть тип контакта</h6>

                    <form class="form" action="{{ route('admin.customer.contact-types.update', $type->id) }}" method="post">
                        ...
                        <div class="form-group m-t-40 row">
                            ...
                            <div class="col-10">
                                <input name="title" type="text" class="form-control" value="{{ $type->title }}" id="title">
                            </div>
                        </div>
